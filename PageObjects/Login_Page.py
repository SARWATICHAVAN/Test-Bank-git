...
class Login_Class:
    ...
    # click_logout_button_css = "img[alt='Logout Icon']"

    # signup_xpath = "/html/body/div/form/li/a"
    ...
    #     self.driver.find_element(By.CSS_SELECTOR, self.click_logout_button_css).click()
